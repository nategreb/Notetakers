...
class TestCourses(TestCase):
    ...
    def test_get_classes(self):
        num_courses = Course.objects.filter(department__name='Computer Science').count()
    ...
    def test_class_with_diff_id(self):
        ...
        num_courses = self.college.course_set.filter(
    ...
    def test_get_all_college_courses(self):
        ...
        num_courses = self.college.course_set.all().count()
        self.assertEqual(num_courses, 3)
